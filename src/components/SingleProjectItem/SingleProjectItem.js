...
const SingleProjectItem = ({
  ...
  return (
    <div
      ...
      className={[
        styles.container,
        selectedProject ? styles.selectedProjectContainer : null,
        selectedRequest ? styles.selectedRequest : null,
      ].join(" ")}
    >
      {project && (
        <div className={[styles.projectCount].join(" ")}>{project.count}</div>
      )}
