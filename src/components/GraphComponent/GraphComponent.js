...
const GraphComponent=({domainName, graphImg, trackerIdx, changeValue, style})=>{
    return (
        <div className={styles.container} style={style}>
            ...
            <div className={styles.content}>
                <div className={styles.domainData}>
                    ...
                    <p className={styles.trackerIdx}>
                        tracker index
                    </p>
                    <div className={styles.changeValueWrap}>
                        <img className={styles.changeValueIcon} src={changeValue>0?valueIncreaseIcon:valueDecreaseIcon} alt="value-change-icon" />
                        <span className={[styles.changeValue, changeValue>0?styles.positiveChange:styles.negativeChange].join(" ")}>{changeValue>0?'+'+changeValue:changeValue}</span>
                    </div>
                </div>
