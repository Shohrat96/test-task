    ...
    render: (value, row, index) => {
      return (
        <div>
          ...
          {row.trend !== "same" && (
            <img
              src={row.trend === "up" ? valueIncreaseIcon : valueDecreaseIcon}
              alt="index-trend-pic"
            />
          )}
        </div>
        ...
        children: (
          <div>
            ...
            {row.posTrend !== "same" && (
              <img
                src={
                  row.posTrend === "up" ? valueIncreaseIcon : valueDecreaseIcon
                }
                alt="position-trend-pic"
              />
            )}
          </div>
        ),
